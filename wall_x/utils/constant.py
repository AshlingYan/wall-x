action_statistic_dof = {
    ...
    "stack_blocks_three_merged": {
        "follow_left_ee_cartesian_pos": {
            "min": [-0.8742129932403564, 0.00094247778179124, -1.9176405141167343],
            "delta": [1.013765598964691, 2.3289839636581022, 1.9184570938870313],
        },
        "follow_left_ee_rotation": {
            "min": [-0.32254429972171783, 0.025511312943697018, -0.3661745530843735],
            "delta": [0.40786203700304025, 1.1996469428300858, 1.4853242275238037],
        },
        "follow_left_gripper": {
            "min": [0.6698427807569504],
            "delta": [0.3299757845282555],
        },
        "follow_right_ee_cartesian_pos": {
            "min": [-0.10144439277648926, -0.004459706929512322, -1.8858014774912968],
            "delta": [0.9462692024111747, 2.3028813737677414, 1.8845390495586207],
        },
        "follow_right_ee_rotation": {
            "min": [-0.08124921549856662, -0.08125145959854124, -0.9241030717134475],
            "delta": [0.4752421059727669, 1.3085673951804637, 1.3934753247499467],
        },
        "follow_right_gripper": {
            "min": [0.6778561998575926],
            "delta": [0.3200404001414776],
        },
    },
    "stack_blocks_test_v1": {
        "follow_left_joint_1": {"min": [-3.14], "delta": [6.28]},
        "follow_left_joint_2": {"min": [-3.14], "delta": [6.28]},
        "follow_left_joint_3": {"min": [-3.14], "delta": [6.28]},
        "follow_left_joint_4": {"min": [-3.14], "delta": [6.28]},
        "follow_left_joint_5": {"min": [-3.14], "delta": [6.28]},
        "follow_left_joint_6": {"min": [-3.14], "delta": [6.28]},
        "follow_left_gripper": {"min": [0.0], "delta": [1.0]},
        "follow_right_joint_1": {"min": [-3.14], "delta": [6.28]},
        "follow_right_joint_2": {"min": [-3.14], "delta": [6.28]},
        "follow_right_joint_3": {"min": [-3.14], "delta": [6.28]},
        "follow_right_joint_4": {"min": [-3.14], "delta": [6.28]},
        "follow_right_joint_5": {"min": [-3.14], "delta": [6.28]},
        "follow_right_joint_6": {"min": [-3.14], "delta": [6.28]},
        "follow_right_gripper": {"min": [0.0], "delta": [1.0]},
    },
